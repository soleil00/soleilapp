import { Api, CardMembership, Extension, Group, Rule, Send, Subscriptions, Support, Timeline, VerifiedUser } from "@mui/icons-material";
...
export const sidenav = [
    ...
    {name:"Privacy Policies",icon:<Rule/>,href:"/policies",secondary:"Terms and Condictions"},
